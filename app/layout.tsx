  ...
  return (
    <html lang="en">
      <body>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-KK7G7SJ2');
            `,
          }}
        />
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KK7G7SJ2"
            height="0"
            width="0"
        ...
        {/* Google tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-17854144169"
          strategy="afterInteractive"
        />
        <Script
          id="google-analytics"
