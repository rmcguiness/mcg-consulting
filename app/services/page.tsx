          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-navy-600 text-sm leading-relaxed">
                  Mobile-first websites for Florida Keys restaurants. Online reservations, menus that work on every phone, Google Business optimization — fill more tables, not just on weekends.
                </p>
              </Link>
              <Link
              ...
              >
                <h3 className="text-xl font-bold text-navy-900 mb-2 flex items-center gap-2">
                  Watersports &amp; Eco-Tour Websites
                  <HiArrowRight className="w-5 h-5 text-navy-400 group-hover:text-navy-900 transition-colors" />
                </h3>
                <p className="text-navy-600 text-sm leading-relaxed">
                  Booking-ready websites for kayak rentals, paddleboard tours, jet skis, and eco-tours. FareHarbor integration, digital waivers, seasonal landing pages — book every activity online.
                </p>
              </Link>
            </div>
          </div>
